...
<script type="text/javascript">
	function sendOk() {
		...
		f.action = "${pageContext.request.contextPath}/free/${mode}_ok.do";
			...
			<main>
				...
				<form name="newsForm" method="post">
					<section class="newsSection">
						...
						<article class="article1 ariticle1-1">
							<table class="newsTable newsTable1-1">
									...
									<tr>
										<td align="center"><c:if test="${mode=='update'}">
											...
											<button type="button" class="btn  btn3"
												onclick="javascript:location.href='${pageContext.request.contextPath}/free/list.do';">${mode=='update'?'수정취소':'등록취소'}</button>
										</td>
									</tr>
								</table>
