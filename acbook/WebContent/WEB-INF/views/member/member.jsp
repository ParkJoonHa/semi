								...
								<tr>
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;">
											<input class="iptM" type="text" name="userId" id="userId"
												value="${mode=='update'? dto.userId : userId}"
												style="width: 95%;"
												${mode=="update" ? "readonly='readonly' ":""} maxlength="15"
												class="iptM" placeholder="아이디">
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;">
											<input type="password" name="userPwd" maxlength="15"
												class="iptM iptM" style="width: 95%;" placeholder="패스워드">
										</p>
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;">
											<input type="password" name="userPwdCheck" maxlength="15"
												class="iptM" style="width: 95%;" placeholder="패스워드 확인">
										</p>
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;">
											<input type="text" name="userName" value="${dto.userName}"
												maxlength="30" class="iptM" style="width: 95%;"
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;">
											<input type="text" name="birth" value="${dto.birth}"
												maxlength="10" class="iptM" style="width: 95%;"
												placeholder="생년월일">
										</p>
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;">
											<select name="selectEmail" onchange="changeEmail();"
												...
												size="13" maxlength="30" class="iptM"> @ <input
												type="text" name="email2" value="${dto.email2}" size="13"
												maxlength="30" class="iptM" readonly="readonly">
										</p>
									</td>
								</tr>
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;"> 
											<select class="selectField" id="tel1" name="tel1">
												...
												class="iptM" maxlength="4"> - <input type="text"
												name="tel3" value="${dto.tel3}" class="iptM" maxlength="4">
										</p>
									</td>
								</tr>
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;">
											<input type="text" name="zip" id="zip"
												value="${dto.zip_code}" class="iptM" readonly="readonly">
									...
									<td style="padding: 0 0 15px 15px;">
										<p style="margin-top: 1px; margin-bottom: 5px;">
											<input type="text" name="addr1" id="addr1"
												value="${dto.addr1}" maxlength="50" class="iptM"
												style="width: 95%;" placeholder="기본 주소" readonly="readonly">
										</p>
										<p style="margin-bottom: 5px;">
											<input type="text" name="addr2" id="addr2"
												value="${dto.addr2}" maxlength="50" class="iptM"
												style="width: 95%;" placeholder="나머지 주소">
										</p>
									</td>
								</tr>
								...
								<tr height="45">
									<td align="center">
										<button type="button" name="sendButton" class="btn"
											onclick="memberOk();">${mode=="member"?"회원가입":"정보수정"}</button>
