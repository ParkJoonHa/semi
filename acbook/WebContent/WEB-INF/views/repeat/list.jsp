...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resource/css/created.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resource/css/repeat.css">
<link
		...
		<div id="mainBody2">
			...
			<main>
				...
				<form name="searchForm"
					action="${pageContext.request.contextPath}/repeat/list.do"
					method="post">
					<section>
						<div class="innerNav">
							<h1>자주하는 질문</h1>
						...
						<article class="article1">
							<div>
								...
								<table class="table2 table2-1" style="border-collapse: collapse;">
									<c:forEach var="dto" items="${list}">
										<tr height="33" class="row-subject">
											<td style="border: 1px solid rgba(125,155,234,0.1);; border-right: none;">${dto.subject}</td>
											<td style="border: 1px solid rgba(125,155,234,0.1);; border-left: none;"
												width="100">${dto.created}</td>
										</tr>
										<tr style="display: none; text-align: left;" height="30">
											<td colspan="2">
												<div>${dto.content}</div> <c:if
													test="${sessionScope.member.userId=='admin'}">
													<div style="text-align: right; padding-right: 5px;">
														<a
															href="${pageContext.request.contextPath}/repeat/update.do?repeatNum=${dto.repeatNum}&page=${page}">수정</a>
														<a
															href="${pageContext.request.contextPath}/repeat/delete.do?repeatNum=${dto.repeatNum}&page=${page}">삭제</a>
													</div>
												</c:if>
										...
										<tr style="height: 1px; margin: 0;">
											<td style="height: 1px; font-size: 0;" colspan="2">&nbsp;</td>
										</tr>
									</c:forEach>
								</table>
								...
								<table
									...
									<tr height="35">
										<td align="center">${dto.dataCount==0?"등록된 게시물이 없습니다.":paging}
										</td>
									</tr>
								</table>
							</div>
								...
								<tr>
									<td>
										<button class="btn btn1" type="button"
											onclick="jacascript:location.href='${pageContext.request.contextPath}/repeat/list.do';"></button>
									</td>
									...
									<c:if
										test="${sessionScope.member.userId=='admin' || sessionScope.member.userId=='master'}">
										<td align="right">
											<button class="btn btn3" type="button"
												onclick="javascript:location.href='${pageContext.request.contextPath}/repeat/created.do';">글올리기</button>
										</td>
									</c:if>
								</tr>
							</table>
